...
// TODO:	this effectively turns off this replace mode,
...
void
Renamer_SearchReplace::RenameList(BList* FileList)
{
...
void
Renamer_SearchReplace::DetachedFromWindow()
{
	BMessage msg;
...
void
Renamer_SearchReplace::AttachedToWindow()
{
	BMessage msg;
