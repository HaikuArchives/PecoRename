	...
	BApplication(kAppsignature)
{
	...
	fRenamers[2] = new Renamer_Random();
	fRenamers[3] = new Renamer_Remove();
	fRenamers[4] = new Renamer_Numbering();
	fRenamers[5] = new Renamer_Extension();
	fRenamers[6] = new Renamer_UpperLower();
}
