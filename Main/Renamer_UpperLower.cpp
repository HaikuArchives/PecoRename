	...
	: Renamer()
{
	...
	myMenu->AddItem(new BMenuItem(B_TRANSLATE("UPPERCASE"),
		new BMessage(MSG_RENAME_SETTINGS)));
	myMenu->AddItem(new BMenuItem(B_TRANSLATE("lowercase"),
		new BMessage(MSG_RENAME_SETTINGS)));
	myMenu->AddItem(new BMenuItem(B_TRANSLATE("Sentence case"),
		new BMessage(MSG_RENAME_SETTINGS)));
	myMenu->AddItem(new BMenuItem(B_TRANSLATE("Title Case"),
		new BMessage(MSG_RENAME_SETTINGS)));
...
Renamer_UpperLower::RenameList(BList* FileList)
{
	...
	int conversionMenuIndex = fUpperOrLower->Menu()
		->IndexOf(fUpperOrLower->Menu()->FindMarked());
